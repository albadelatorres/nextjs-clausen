...
export default function Home() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("https://fugemesterclausen-backend.onrender.com/contact", {
        method: "POST",
      ...
      <main className="bg-gradient-to-b from-sage-50 to-sage-100">
            ...
            <div className="relative z-30 text-center max-w-3xl bg-gradient-to-b from-sage-900/60 to-sage-800/50 backdrop-blur-sm rounded-xl px-8 py-8">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight text-white">
                <span className="block">
                  Velkommen til <strong className="font-semibold">Fugemester Clausen</strong>
                </span>
                <span className="block mt-2 text-lg sm:text-xl md:text-5xl font-semibold">
                  Din lokale <strong className="font-semibold">fugemand</strong>
                </span>
              </h1>
              <h3 className="mt-6 text-lg sm:text-xl text-white/90 mb-8">
                Få professionel <strong className="font-semibold">fugeservice</strong> til konkurrencedygtige priser i <strong className="font-semibold">Kolding</strong> og omegn samt <strong className="font-semibold">Vejle, Fredericia og Middelfart</strong> – vi beskytter dit hjem med præcision og holdbare løsninger.
              </h3>
              <Link
                href="/#kontakt"
        ...
        <section className="py-16 bg-sage-100">
          ...
          <div className="mx-auto max-w-2xl h-96 border rounded-lg overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2256.693990296125!2d9.4050672769615!3d55.55511470720026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x464b61e87c181c7b%3A0x7c396d7325831907!2sElkærholmparken%206b%2C%206040%20Egtved%2C%20Dinamarca!5e0!3m2!1sda!2sdk!4v1750788830240!5m2!1sda!2sdk"
